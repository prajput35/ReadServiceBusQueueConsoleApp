...
namespace queue_receive
{
    class Program
    {
        private static string _bus_connectionstring = "Endpoint=sb://demoservicebusns.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=fVsy3ecOuLowdfn84d9Pr15A539zqepvO5VqGbkUH7I=";
        private static string _queue_name = "demoqueue";
        ...
        {
            Console.WriteLine($"Message ID : {Encoding.UTF8.GetString(_message.Body)}");
